...
def tick():
    time_string = time.strftime('%I:%M:%S %p')  # 12-hour format with AM/PM
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"      |    ", fg="orange",bg="#2D430B" ,width=55 ,height=1,font=('Arial', 14, ' bold '))

datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="orange",bg="#2D430B" ,width=55 ,height=1,font=('Arial', 14, ' bold '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="#00fcca",width=42 ,height=1,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="#00fcca",width=43 ,height=1 ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)
